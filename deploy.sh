...
if [[ $1 == vue ]]; then
    ...
    cd frontend
    yarn build
    rsync --delete -azv -e "ssh -i ~/.ssh/mcculleydj.dev.pem" dist/ ubuntu@54.203.119.188:/home/ubuntu/cosign
    ...
    scp -i ~/.ssh/mcculleydj.dev.pem main ubuntu@54.203.119.188:~/cosign-api
